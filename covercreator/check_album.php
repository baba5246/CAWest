...
$startTime = microtime(true);
	...
	function make_image_photo($fb_user,$fb_user_name,$template_id,$photo_picture_path,$cover_position_top=null,$cover_file_suffix,$log_picture) {
		...
		if($template_id){
			...
			$icon_photo_picture_0 = imagecreatefromjpeg($log_picture."photo/".$fb_user."/display_photo_".$fb_user."_".$photo_picture_path_list[0].".jpeg"); 
			$size_photo_picture_0 = getimagesize($log_picture."photo/".$fb_user."/display_photo_".$fb_user."_".$photo_picture_path_list[0].".jpeg");
		...
		if($template_id){
			...
			$icon_photo_picture_0 = imagecreatefromjpeg($log_picture."photo/".$fb_user."/photo_".$fb_user."_".$photo_picture_path_list[0].".jpeg"); 
			$size_photo_picture_0 = getimagesize($log_picture."photo/".$fb_user."/photo_".$fb_user."_".$photo_picture_path_list[0].".jpeg");
...
var ctrl = null;
	...
	function doPhotosSelect(page_id,action,template_id,album_id,page_no_photo){
		...
		document.form01.album_id.value=album_id;
...
<div id="page_btn">
<div id="btn_back"><img src="img/btn_back.jpg" width="275" height="61" alt="BACK" onClick="javascript:doPhotosSelect('picture_album_photo','photos_select','<?php echo($template_id);?>','<?php echo($album_id);?>','<?php echo($page_no_photo);?>')">
</div>
<div id="btn_next"><img src="img/btn_save.jpg" width="275" height="61" alt="SAVE" onClick="javascript:doPhotosSelect('thanks','photos_wall','<?php echo($template_id);?>','<?php echo($album_id);?>','<?php echo($page_no_photo);?>')">
</div>
...
<input type="hidden" name="category_id" value="album" />
...
$endTime = microtime(true);
	...
	$my365_user_id = "";
	$insta_user_id = "";
	$access_page = "check_album_".$action_flg."_".$template_id;
